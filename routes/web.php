...
Route::group(['prefix' => 'level'], function(){
    Route::get('/', [LevelController::class, 'index']); //menampilkan halamann awal user
...
Route::group(['prefix' => 'supplier'], function(){
    Route::get('/', [SupplierController::class, 'index']); //menampilkan halamann awal user
...
Route::group(['prefix' => 'barang'], function(){
    Route::get('/', [BarangController::class, 'index']); //menampilkan halamann awal user
    ...
    Route::get('/{id}/delete_ajax', [BarangController::class, 'confirm_ajax']); //untuk menampilkan form confirm delete user ajax
