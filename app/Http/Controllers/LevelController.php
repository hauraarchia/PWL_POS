...
class LevelController extends Controller
{
    ...
    public function index()
    {
        ...
        $kategories = LevelModel ::all(); //ambil data kategori untuk filter kategori
    ...
    //     {
    //         $kategories = LevelModel ::select('kategori_id', 'kategori_kode', 'kategori_nama');
    ...
    public function create()
    {
        ...
        $kategories = LevelModel ::all(); // ambil data kategori untuk ditampilkan di form  
        $activeMenu = 'kategori'; // set menu yang sedang aktif  
    ...
    public function destroy(string $id)
    {
        ...
        try {
            LevelModel ::destroy($id); //hapus data kategori
    ...
    {
        $kategori = LevelModel ::select('kategori_kode', 'kategori_nama')->get();
    ...
    public function list(Request $request)
    {
        $kategori = LevelModel ::select('kategori_id', 'kategori_kode', 'kategori_nama');
    ...
    public function edit_ajax(string $id)
    {
        ...
        // $kategori = LevelModel ::select('kategori_id', 'kategori_nama')->get();
